...
class V_Main extends Vista{
    ...
    {
        $this->inicio_html("Pagina de inicio", ['../../styles/general.css', '../../styles/tablas.css']);
        if (!isset($_COOKIE['jwt'])){
            ...
            <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                ...
                <button type="submit" name="idp" id="idp2" value="registrar">Registrese</button>
            </form>
            ...
            <form action="POST" action="<?=$_SERVER['PHP_SELF']?>">
                ...
                <button type="submit" name="idp" id="idp3" value="buscar">Buscar artículo</button>
            </form>
            <?
        } else {
        ?>
        ...
        foreach($datos as $articulo_oferta){
            echo "<tr>";
                ...
                echo "<td>" . floatval($articulo_oferta['dto']) * 100 . "</td>";
